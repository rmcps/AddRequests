define([], function() {
  return {
    "PropertyPaneDescription": "Configure the list form here. The list must be configured before a record can be saved.",
    "BasicGroupName": "Settings",
    "RequestListFieldLabel": "Requests list title",
